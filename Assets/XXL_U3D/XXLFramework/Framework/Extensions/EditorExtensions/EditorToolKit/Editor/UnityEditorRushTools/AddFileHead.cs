...
namespace XXLFramework
{
    ...
    {
        #region 更新格式
        //[MenuItem("XXLFramework/Tool/File/2.更新文件头格式")]
        ...
        /// 用notepad++打开文件
        /// </summary>
        //[MenuItem("XXLFramework/Tool/File/1.编辑文件头格式 NotePad++")]
        static public void OpenForNotePadJJ()
        {
            string dir_path = Application.dataPath + "/XXLFramework/Framework/4.EditorToolKit/Editor/UnityEditorRushTools/AddFileHead.cs";
        ...
        /// 用记事本打开文件
        /// </summary>
        //[MenuItem("XXLFramework/Tool/File/1.编辑文件头格式 记事本")]
