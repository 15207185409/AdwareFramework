...
")]
        ...
        {
            return XXLFramework.Delay.Allocate(seconds, callback);
        }
...
")]
        ...
        {
            return XXLFramework.Sequence.Allocate();
        }
...
")]
        ...
        {
            return XXLFramework.DelayFrame.Allocate(frameCount, onDelayFinish);
        }

        public static IAction NextFrame(Action onNextFrame)
        {
            return XXLFramework.DelayFrame.Allocate(1, onNextFrame);
        }
...
// Right click finished
    ")]
        ...
        {
            return XXLFramework.Repeat.Allocate(repeatCount);
        }
...
")]
        ...
        {
            return XXLFramework.Parallel.Allocate();
        }
...
")]
        ...
        {
            var action = XXLFramework.Custom.Allocate();
        ...
        {
            var action = XXLFramework.Custom<TData>.Allocate();
            customSetting(action);
            return action;
        }
