...
namespace XXLFramework
{
    ...
    public class PackageInfosRequestCache
    {
        ...
        private static string mFilePath
        {
            get
            {
                var dirPath = Application.dataPath + "/XXL_U3D/XXLFramework/Framework/Toolkits/_CoreKit/PackageKit/PackageManager/";
    ...
    {
        public const string Preferences = "XXLFramework/Preferences... %e";
