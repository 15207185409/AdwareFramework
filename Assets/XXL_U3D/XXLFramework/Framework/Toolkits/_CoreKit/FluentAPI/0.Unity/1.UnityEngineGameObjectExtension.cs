...
")]
#endif
        public static void Layer(this GameObject selfObj, int layer, bool containChildren = false)
        {
            selfObj.layer = layer;
			if (containChildren)
			{
				for (int i = 0; i < selfObj.transform.childCount; i++)
				{
                    selfObj.transform.GetChild(i).gameObject.Layer(layer, true);
				}
			}
        }
...
")]
#endif
        public static void Layer<T>(this T selfComponent, int layer, bool containChildren = false) where T : Component
        {
            ...
            if (containChildren)
            {
                ...
                {
                    selfComponent.transform.GetChild(i).gameObject.Layer(layer, true);
                }
            }
        }
...
")]
        ...
        public static void Layer(this GameObject selfObj, string layerName, bool containChildren = false)
        {
