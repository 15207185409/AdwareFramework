...
namespace XXLFramework
{
    ...
    [DisplayNameCN("用户手册")]
    [DisplayNameEN("UserGuide")]
    public class Guideline : IPackageKitView
    {
        ...
        public void Init()
        {
            ...
            mLeftLayout = EasyIMGUI.Area().WithRectGetter(() => mLeftRect)
                ...
                .AddChild(EasyIMGUI.Custom().OnGUI(() =>
                {
                    ...
                    //    var savedPath = EditorUtility.SaveFilePanel($"XXLFramework {framework.Version} {guidelineText}", Application.dataPath,
                    //        $"XXLFramework {framework.Version} {guidelineText}", "md");
