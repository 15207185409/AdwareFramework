...
")]
    ...
    { 
        ...
        void LoadClipAsync(string audioName, Action<bool,AudioClip> onLoad);
        void Unload();
    ...
    public class DefaultAudioLoader : IAudioLoader
    {
        ...
        {
            mClip = Resources.Load<AudioClip>(clipName);
            return mClip;
        }

        public void LoadClipAsync(string clipName, Action<bool,AudioClip> onLoad)
        {
            var resourceRequest = Resources.LoadAsync<AudioClip>(clipName);
