...
namespace XXLFramework
{
    public class AudioPlayer : IPoolable, IPoolType
    {
        ...
        public void SetAudio(GameObject root, string name, bool loop)
        {
            ...
            mLoader.LoadClipAsync(name, OnResLoadFinish);
        ...
        public void Pause()
        {
            ...
            if (mTimeItem != null)
            {
                mLeftDelayTime = mTimeItem.SortScore - XXLFramework.Timer.Instance.currentScaleTime;
                mTimeItem.Cancel();
                mTimeItem = null;
            }
        ...
        public void Resume()
        {
            ...
            if (mLeftDelayTime >= 0)
            {
                mTimeItem = XXLFramework.Timer.Instance.Post2Scale(OnResumeTimeTick, mLeftDelayTime);
            }
        ...
        private void OnResumeTimeTick(int repeatCount)
        {
            ...
            if (mIsLoop)
            {
                mTimeItem = XXLFramework.Timer.Instance.Post2Scale(OnSoundPlayFinish, mAudioClip.length, -1);
            }
        }
